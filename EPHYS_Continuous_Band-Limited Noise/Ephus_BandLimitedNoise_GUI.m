...
puretonesGUI = figure('units','normalized','position',[0.2 0.5 0.45 0.45],...
    'menubar','none','numbertitle','off','name','Band-Limited Gaussian Noise Specifications');
...
BW_Oct_txt = uicontrol('parent',puretonesGUI,'style','text',...
    'string','Noise BandWidth (Octave) = ', 'units','normalized',...
    'position',[xtext ytext Ltext Htext],'fontsize',9,...
    'fontname','times new roman',...
    'backgroundcolor',get(puretonesGUI,'color'),...
    'horizontalalignment','right');
...
ytext = ytext - RowSpace;
Mod_Freq_txt = uicontrol('parent',puretonesGUI,'style','text',...
    'string','Modulation Freq (Hz) = ', 'units','normalized',...
    'position',[xtext ytext Ltext Htext],'fontsize',9,...
    'fontname','times new roman',...
    'backgroundcolor',get(puretonesGUI,'color'),...
    'horizontalalignment','right');

Mod_Freq_h = uicontrol('parent',puretonesGUI,'style','edit',...
...
Amp_Array_h = uicontrol('parent',puretonesGUI,'style','edit',...
    'string','[40:20:80]','units','normalized','position',[xval ytext Lval Hval],...
...
Pulse_Dur_h = uicontrol('parent',puretonesGUI,'style','edit',...
    'string',300,'units','normalized','position',[xval ytext Lval Hval],...
    'tag','Pulse_Dur');
