...
Amp_h = uicontrol('parent',puretonesGUI,'style','edit',...
    'string','85','units','normalized','position',[xval 0.8 1.0*Lval 0.065],...
    'fontsize',8,'tag','Amp');
...
ISI_h = uicontrol('parent',puretonesGUI,'style','edit',...
    'string',5000,'units','normalized','position',[xval 0.7 Lval 0.065],...
    'tag','ISI');
...
NCam_h = uicontrol('parent',puretonesGUI,'style','edit',...
    'string',5,'units','normalized','position',[xval 0.2 Lval 0.065],...
    'tag','NCam');
