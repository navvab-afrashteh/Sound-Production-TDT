...
min_Freq_h = uicontrol('parent',puretonesGUI,'style','edit',...
    'string',3,'units','normalized','position',[xval a Lval 0.065],...
    'tag','min_Freq');
...
max_Freq_h = uicontrol('parent',puretonesGUI,'style','edit',...
    'string',48,'units','normalized','position',[xval a Lval 0.065],...
    'tag','max_Freq');
...
Amp_Array_h = uicontrol('parent',puretonesGUI,'style','edit',...
    'string','[20:15:80]','units','normalized','position',[xval a 1.0*Lval 0.065],...
...
Pulse_Dur_h = uicontrol('parent',puretonesGUI,'style','edit',...
    'string',50,'units','normalized','position',[xval a Lval 0.065],...
    'tag','Pulse_Dur');
...
ISI_h = uicontrol('parent',puretonesGUI,'style','edit',...
    'string',3000,'units','normalized','position',[xval a Lval 0.065],...
    'tag','ISI');
...
jitter_percentage_h = uicontrol('parent',puretonesGUI,'style','edit',...
    'string',20,'units','normalized','position',[xval a Lval 0.065],...
...
Ntrials_h = uicontrol('parent',puretonesGUI,'style','edit',...
    'string',14,'units','normalized','position',[xval a Lval 0.065],...
    'tag','Ntrials');
...
run_button = uicontrol('parent',puretonesGUI,'style','pushbutton',...
    ...
    'Callback',@run_button_Callback_Tinnitus_Tones);
